...
export default function Home() {
  return (
    <div className="relative min-h-full overflow-x-hidden">
      ...
      <Reveal>
        <section className="relative mx-auto flex h-screen max-w-[1600px] flex-col items-center justify-center space-y-8 text-virtuo-black-origin dark:text-virtuo-white-origin">
      ...
      <Reveal>
        <section className="mx-auto mt-10 flex h-fit min-h-[1100px] max-w-[1600px] items-center justify-center">
          <div className="mx-auto h-[80vh] max-h-[700px] w-[90%] rounded-3xl bg-gradient-to-tr from-[#FFF5EE]/100 via-[#FFFFFF]/100 to-[#FFF5EE]/100 dark:from-[#3B3B3B]/15 dark:via-[#050505]/80 dark:to-virtuo-black-one/50">
            <div className={`${styles.introduction}`}>
              <div className="relative flex size-full flex-col items-center justify-start rounded-3xl bg-gradient-to-tr">
                ...
                <p className="mt-10 w-1/2 text-center text-virtuo-black-one dark:text-virtuo-white-origin/50">
      ...
      <Reveal>
        <section className="relative mx-auto mt-10 flex h-fit w-[80%] max-w-[1600px] flex-col items-center justify-center space-x-6 space-y-6 bg-transparent sm:space-x-0 md:w-full lg:w-[90%] lg:flex-row lg:space-x-20 lg:space-y-0">
          <div className="flex flex-col whitespace-nowrap text-center text-3xl font-medium md:text-5xl">
            <p className="font-dmsans">
              Your Personal
              <br />
      ...
      <Reveal>
        <section className="relative mx-auto mt-10 w-[90%] max-w-[1600px] items-center justify-center space-y-6">
          <div className="flex flex-col whitespace-nowrap text-center text-3xl font-medium md:text-5xl">
            <p className="font-dmsans">
              Facilitating{" "}
              <span className="bg-gradient-to-r from-virtuo-orange-gradientStart to-virtuo-orange-gradientEnd bg-clip-text pr-1 font-volkhov text-3xl font-medium italic text-transparent md:text-5xl">
