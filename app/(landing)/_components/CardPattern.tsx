  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        ...
        style={style}
      >
        <p className="absolute inset-x-0 h-full overflow-hidden whitespace-pre-wrap break-words font-mono text-xs font-bold text-white-origin transition duration-500">
          {randomString}
        </p>
      </motion.div>
    </div>
