...
const NotFound = () => {
  return (
    <div className="relative flex h-screen w-full overflow-hidden rounded-md bg-white-origin antialiased dark:bg-[#040404] md:items-center md:justify-center">
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col space-y-6 p-4 pt-20 md:pt-0">
        ...
        <Button
          variant="outline"
          size="lg"
          className="mx-auto rounded-lg text-base transition-all duration-500 hover:bg-accent-foreground hover:text-white-origin dark:bg-secondary dark:hover:bg-secondary/70"
        >
